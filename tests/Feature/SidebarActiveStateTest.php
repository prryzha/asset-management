...
/**
 * Regresi untuk temuan audit pre-demo: link sidebar "Peminjaman" ikut aktif
 * bareng "Rekap Peminjaman" saat membuka /transactions/rekap, karena kondisi
 * exclude-nya (routes/components/sidebar.blade.php) cuma mengecualikan
 * transactions.report* dan lupa mengecualikan transactions.recap* yang baru
 * ditambahkan. Fix-nya menambah satu exclude lagi ke kondisi yang sama.
 */
class SidebarActiveStateTest extends TestCase
{
    ...
    public function test_recap_page_activates_only_rekap_peminjaman_link(): void
    {
        ...
        $this->assertFalse($this->sidebarLinkIsActive($html, route('transactions.report')), 'Laporan Peminjaman tidak boleh aktif.');
    }

...
@section('title', __('ui.categories.ubah_kategori'))

@section('content')
<div class="page-content">

    <x-ui.page-header :title="__('ui.categories.ubah_kategori')">
        <x-slot:actions>
            ...
            <div class="card-body">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $category->nama) }}" required class="form-input @error('nama') is-invalid @enderror" placeholder="{{ __('ui.categories.nama_kategori_placeholder') }}">

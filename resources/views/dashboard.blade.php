...
<div class="p-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <div class="stat-card">
            <div class="flex items-start gap-4">
                <div class="stat-icon bg-danger-50">
        ...
        <div class="xl:col-span-3 space-y-6">
            ...
            <div class="card">
                ...
                <div class="px-5 py-3 border-t border-[#E5E7EB]">
                    <a href="{{ route('maintenance.index') }}" class="text-xs font-medium text-primary hover:text-primary-hover transition-colors">
        ...
        <div class="xl:col-span-2 space-y-6">
                ...
                <div class="card-body space-y-4">
                    <div>
                        <div class="flex justify-between items-center mb-1.5">
                            <span class="text-sm text-[#111827]">Baik</span>
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-1.5">
                            <span class="text-sm text-[#111827]">Kurang Baik</span>
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-1.5">
                            <span class="text-sm text-[#111827]">Rusak Berat</span>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('transactions.index') }}" class="text-xs font-medium text-primary hover:text-primary-hover transition-colors">
                        Lihat Semua &rarr;
                    </a>
                </div>
                <div class="table-container">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('activity-logs.index') }}" class="text-xs font-medium text-primary hover:text-primary-hover transition-colors">
                Lihat Semua &rarr;
            </a>
        </div>
        <div class="divide-y divide-border">
            @forelse($recentActivities as $activity)
            <div class="flex items-start gap-3 px-5 py-3.5 hover:bg-[#F5F7FA] transition-colors">
                <div class="flex-shrink-0 mt-0.5">
                    @php
                        ...
                        if(\Illuminate\Support\Str::contains($event,'created')){ $bg='bg-primary-50'; $iconColor='text-primary'; $svgIcon='<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>'; }
                        elseif(\Illuminate\Support\Str::contains($event,'updated')){ $bg='bg-primary-50'; $iconColor='text-primary'; $svgIcon='<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.586-9.414a2 2 0 112.828 2.828L12 14l-4 1 1-4 8.414-8.414z"/>'; }
                        elseif(\Illuminate\Support\Str::contains($event,'deleted')){ $bg='bg-danger-50'; $iconColor='text-danger'; $svgIcon='<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>'; }
                    @endphp
...
document.addEventListener('DOMContentLoaded', function () {
    const chartDefaults = {
        ...
        plugins: {
            legend: {
                position: 'bottom',
                labels: { usePointStyle: true, padding: 14, font: { size: 11, family: 'Poppins', weight: '500' } }
            }
        }
    };
    ...
    if (lokasiCanvas) {
        new Chart(lokasiCanvas, {
            ...
            options: {
                ...
                scales: {
                    y: { beginAtZero: true, ticks: { precision: 0, font: { size: 10, family: 'Poppins' } } },
                    x: { ticks: { font: { size: 9, family: 'Poppins' } } }
                }
            }
        });
    }

...
@section('title', __('ui.maintenance.ubah_jadwal_title'))

@section('content')
<div class="page-content">

    <x-ui.page-header :title="__('ui.maintenance.ubah_jadwal_title')">
        <x-slot:actions>
            ...
            <div class="card-body">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jenis_perawatan" value="{{ old('jenis_perawatan', $maintenanceSchedule->jenis_perawatan) }}" required class="form-input @error('jenis_perawatan') is-invalid @enderror" placeholder="{{ __('ui.maintenance.jenis_perawatan_placeholder') }}">
                    ...
                    <div class="form-group md:col-span-2">
                        ...
                        <input type="text" name="teknisi" value="{{ old('teknisi', $maintenanceSchedule->teknisi) }}" class="form-input @error('teknisi') is-invalid @enderror" placeholder="{{ __('ui.maintenance.teknisi_placeholder') }}">
                        @error('teknisi')<p class="form-error">{{ $message }}</p>@enderror
                    </div>

                    <div class="form-group md:col-span-2">
                        <label class="form-label">{{ __('ui.assets.catatan') }}</label>
                        <textarea name="catatan" rows="4" class="form-input @error('catatan') is-invalid @enderror" placeholder="{{ __('ui.maintenance.catatan_placeholder') }}">{{ old('catatan', $maintenanceSchedule->catatan) }}</textarea>

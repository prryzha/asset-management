    ...
    <nav class="sidebar-nav scrollbar-hidden">
        ...
        <div class="sidebar-section">
            ...
            <a href="{{ route('assets.index') }}"
               class="sidebar-link {{ request()->routeIs('assets.*') && !request()->routeIs('assets.archive*') && !request()->routeIs('assets.hilang*') ? 'active' : '' }}">
                <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="sidebar-section">
            ...
            <a href="{{ route('transactions.index') }}"
               class="sidebar-link {{ request()->routeIs('transactions.*') && !request()->routeIs('transactions.report*') && !request()->routeIs('transactions.recap*') ? 'active' : '' }}">
                <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('mutasi.index') }}"
               class="sidebar-link {{ request()->routeIs('mutasi.*') ? 'active' : '' }}">
                <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a2 2 0 01-2.828 0l-4.243-4.243a8 8 0 1111.314 0z"/>
        ...
        <div class="sidebar-section">
            ...
            <a href="{{ route('assets.hilang') }}"
               class="sidebar-link {{ request()->routeIs('assets.hilang*') || request()->routeIs('assets.archive*') ? 'active' : '' }}">
                <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17V7m6 10v-4M9 7a2 2 0 012-2h2a2 2 0 012 2m-6 0H7a2 2 0 00-2 2v8a2 2 0 002 2h10a2 2 0 002-2V9a2 2 0 00-2-2h-2"/>
                </svg>
                Laporan Aset
            </a>

            <a href="{{ route('transactions.report') }}"
               class="sidebar-link {{ request()->routeIs('transactions.report*') || request()->routeIs('transactions.recap*') ? 'active' : '' }}">
                <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">

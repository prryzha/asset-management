...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    ...
    <div class="card p-4">
        <div class="flex items-center justify-between mb-3">
            <h3 class="text-sm font-normal text-gray-800 dark:text-gray-200">Status Aset</h3>
    ...
    <div class="card p-4">
        <div class="flex items-center justify-between mb-3">
            <h3 class="text-sm font-normal text-gray-800 dark:text-gray-200">Kategori</h3>
    ...
    <div class="card p-4">
        <div class="flex items-center justify-between mb-3">
            <h3 class="text-sm font-normal text-gray-800 dark:text-gray-200">Lokasi</h3>
    ...
    <div class="card p-4">
        <div class="flex items-center justify-between mb-3">
            <h3 class="text-sm font-normal text-gray-800 dark:text-gray-200">Kondisi Aset</h3>

...
<div class="p-8">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div class="card-body">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Catatan</p>
                    ...
                    <div class="table-container">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="font-medium">{{ $t->nama_peminjam }}</td>
                                    <td>{{ $t->keperluan }}</td>
                    ...
                    <div class="table-container">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="font-medium">{{ $m->jenis_perawatan }}</td>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-4 pl-4 border-l-4
                            ...
                            <div class="flex-1">
                                ...
                                <p class="font-medium text-gray-900 dark:text-gray-100 mt-1">{{ $log->deskripsi }}</p>
        ...
        <div class="space-y-6">
            ...
            <div class="card p-6">
                <h3 class="font-bold text-gray-900 dark:text-gray-100 mb-4 text-sm uppercase tracking-wider text-gray-400 dark:text-gray-500">Info Tambahan</h3>
                <div class="space-y-3 text-sm">
                    <div class="flex justify-between">
                        <span class="text-gray-400 dark:text-gray-500">Nomor Seri</span>
                        <span class="font-medium text-gray-900 dark:text-gray-100">{{ $asset->nomor_seri ?? '—' }}</span>
                    </div>
                    <div class="flex justify-between">
            ...
            <div class="card p-6">
                ...
                <div class="space-y-2">
                    <a href="{{ route('assets.edit', $asset) }}"
                       class="flex items-center gap-2 w-full px-3 py-2 rounded bg-blue-50 text-blue-700 hover:bg-blue-100 dark:bg-primary-900/30 dark:text-primary-300 dark:hover:bg-primary-900/50 transition text-sm font-medium">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.586-9.414a2 2 0 112.828 2.828L12 14l-4 1 1-4 8.414-8.414z"/>
                        </svg>
                        Edit Aset
                    ...
                    <a href="{{ route('maintenance.create') }}?asset_id={{ $asset->id }}"
                       class="flex items-center gap-2 w-full px-3 py-2 rounded bg-orange-50 text-orange-700 hover:bg-orange-100 dark:bg-orange-900/30 dark:text-orange-300 dark:hover:bg-orange-900/50 transition text-sm font-medium">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        Jadwalkan Perawatan
                            ...
                            <button type="button" onclick="openReportDamage()"
                                    class="flex items-center gap-2 w-full px-3 py-2 rounded bg-danger-50 text-danger-700 hover:bg-danger-100 dark:bg-red-900/30 dark:text-red-300 dark:hover:bg-red-900/50 transition text-sm font-medium">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    Swal.fire({
        ...
        html: `
            <div class="text-left">
                ...
                <label class="block text-sm font-semibold text-gray-700 mb-1.5">Deskripsi Kerusakan</label>

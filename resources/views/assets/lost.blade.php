...
<div class="p-8">
    ...
    <x-ui.report-tabs :tabs="[
        ['label' => 'Aset Hilang', 'url' => route('assets.hilang'), 'active' => true],
        ['label' => 'Arsip', 'url' => route('assets.archive'), 'active' => false],
    ]" />
    ...
    <div class="card mb-6">
        <div class="card-body py-2.5">
            <form action="{{ route('assets.hilang') }}" method="GET" class="flex flex-wrap items-center gap-2">
                ...
                <a href="{{ route('assets.hilang') }}" class="btn-ghost btn-sm">Reset Filter</a>
                @endif
            </form>
        </div>
    </div>

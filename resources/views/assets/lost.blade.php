...
<div class="page-content">
    ...
    <x-ui.page-header title="Laporan Aset" />

    {{-- Search & Filter --}}
    <div class="card overflow-hidden">
        <x-ui.table-heading title="Daftar Aset Hilang">
        ...
        <div class="card-body-compact border-b border-default">
            <form action="{{ route('assets.hilang') }}" method="GET" class="filter-form">
                ...
                <a href="{{ route('assets.hilang') }}" class="btn-ghost btn-xs">Reset Filter</a>
                @endif
            </form>
        </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr class="cursor-pointer asset-row" data-url="{{ route('assets.show', $asset) }}">
                        ...
                        <td class="text-center">
                            <a href="{{ route('assets.show', $asset) }}" class="btn-ghost btn-icon" title="Rincian" aria-label="Rincian {{ $asset->nama_barang }}">
                    ...
                    <tr>
                        <td colspan="7" class="text-center py-16">
                            <x-ui.empty-state
                                icon="search"
                                title="Tidak Ada Aset Hilang"
                                description="Belum ada aset yang dilaporkan hilang, atau semua laporan sudah ditemukan kembali." />
                        </td>
                    </tr>
                    @endforelse
                </tbody>

...
return [
    ...
    'encoding' => 'The :attribute must use the :encoding encoding.',
    ...
    /*
    |--------------------------------------------------------------------------
    | English labels for field names — mirrors lang/id/validation.php's
    | attributes array key-for-key so both locales always stay in sync.
    |--------------------------------------------------------------------------
    */
    'attributes' => [
        'nama' => 'name',
        ...
        'catatan' => 'notes',
        'catatan_selesai' => 'completion notes',
        'foto' => 'photo',
        'status' => 'status',
        'gedung' => 'building',

...
return [
    ...
    'prohibits' => ':attribute membuat :other dilarang untuk diisi.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Label Bahasa Indonesia untuk nama field
    |--------------------------------------------------------------------------
    | Dikumpulkan dari seluruh validate() di app/Http/Controllers — supaya
    | pesan error tidak menampilkan nama field mentah seperti "nama_barang".
    */
    'attributes' => [
        'nama' => 'nama',
        ...
        'catatan' => 'catatan',
        'catatan_selesai' => 'catatan penyelesaian',
        'foto' => 'foto',
        'status' => 'status',
        'gedung' => 'gedung',
        'deskripsi' => 'deskripsi',
